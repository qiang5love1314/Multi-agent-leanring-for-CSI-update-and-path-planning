...
from Visualization import visualize_paths, darp_area_visualization
import sys
import argparse
    ...
    def __init__(self, nx, ny, notEqualPortions, initial_positions, portions,
        ...
        if not self.DARP_success:
            ...
            if self.darp_instance.visualization:
                ...
                # self.assignment_matrix_visualization = darp_area_visualization(self.darp_instance.A, self.darp_instance.droneNo, self.darp_instance.color, self.darp_instance.initial_positions)
