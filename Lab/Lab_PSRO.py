...
# start_positions; num_learners（代码132,210,314行）根据智能体个数需要调整, 还有def calculate_payoffs(rewards): num_agents = 5（195行）; 

parser = argparse.ArgumentParser(description='Policy space diversity for multi areas based-PSRO')
parser.add_argument('--dim', type=int, default=100)
parser.add_argument('--nb_iters', type=int, default=10)
...
def psro_steps(iters=5, payoffs=None, verbose=False, seed=0, num_learners=5, improvement_pct_threshold=.03, lr=.2, loss_func='dpp', full=False):
    dim = payoffs.shape[0]
...
def psro_steps_fixed_starting_positions(start_positions, movable_coordinates, iters=10, payoffs=None, verbose=False, seed=0,
    ...
    for i in range(iters):
        ...
        for j in range(num_learners):
            ...
            best_path.append(movable_coordinates[j][best_move_index])
    ...
    # np.save('/Users/zhuxiaoqiang/Desktop/IEEE Trans/BJTU-third multi agent/main/Lab/optimal_path_CPPU.npy', best_ranges)
    # np.save('/Users/zhuxiaoqiang/Desktop/IEEE Trans/BJTU-third multi agent/main/Experiments/PSRO_Path_Analysis/Lab_iter50_PSRO_Path.npy', best_ranges)
    # np.save('/Users/zhuxiaoqiang/Desktop/IEEE Trans/BJTU-third multi agent/main/Experiments/AgentNum_Analysis/Lab/Optimal50iter_ThreeAgent_(1,1)(12,1)(21,1)_path.npy',best_ranges)
    # np.save('/Users/zhuxiaoqiang/Desktop/IEEE Trans/BJTU-third multi agent/main/Experiments/AgentNum_Analysis/2Agents_Optimal10iter_path.npy', best_ranges)
    np.save('/Users/zhuxiaoqiang/Desktop/IEEE Trans/BJTU-third multi agent/main/Experiments/RewardCompare/lab/5Agents_Optimal50iter_path.npy', best_ranges)
...
def run_experiments(num_experiments=4, iters=40, num_threads=20, dim=60, lr=0.6, thresh=0.001, logscale=True, psro=False):
    params = {
